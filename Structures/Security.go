...
//
//func (s *SecurityService) GetCertificateTemplates() (CertificateTemplatesDefaultList, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetCertificateTemplate(template string) (CertificateTemplateDefault, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) CreateCertificateTemplate(templateProperties CertificateTemplateProperties) (Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetCertificateAuthorities() (CertificateAuthoritiesDefaultList, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetCertificateAuthority(id string) (CertificateAuthorityDefault, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetCertificateAuthorityProperties(id string) (CertificateAuthorityProperties, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetCertificates() (CertificateDefaultList, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) AddCertificate(certificatePem string, trusted bool) (Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetCertificate(id string) (Certificate, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetCertificateProperties(id string) (CertificateProperties, Structures.RestErrorResponse, http.Response) {
//	idUri := url.QueryEscape(id)
...
//}
//
//func (s *SecurityService) DeleteCertificate(id string) (Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetExternalSecurity() (ExternalSecurityDefaultList, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetExternalSecurityConfiguration(extSecurityConfig string) (ExternalSecurityConfiguration, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) GetExternalSecurityProperties(extSecurityConfig string, parms ExternalSecurityParameters) (interface{}, Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) AddExternalSecurityConfiguration(externalSecurityParameters ExternalSecurityConfigurationParameters) (Structures.RestErrorResponse, http.Response) {
...
//}
//
//func (s *SecurityService) UpdateExternalSecurityConfiguration(externalSecurityParameters ExternalSecurityConfigurationParameters) (Structures.RestartResponse, Structures.RestErrorResponse, http.Response) {
//
//	body, err := json.Marshal(externalSecurityParameters)
//	if err != nil {
//		log.Fatalln(err)
...
//}
//
//func (s *SecurityService) DeleteExternalSecurityConfiguration(extSecurityConfig string) (Structures.RestartResponse, Structures.RestErrorResponse, http.Response) {
//
